...
class AdaniGraphExtractor(BaseGraphExtractor):
    """
    Dedicated Graph Extractor for Adani Electricity Bills.
    """
    ...
    def extract_history(self, text: str, page_image=None, bill_date_str: str = "") -> List[PaymentHistoryItem]:
        ...
        text_pay_map = {}
        history_idx = -1
        keywords = ["payment history", "consumption history", "last 6 months"]
